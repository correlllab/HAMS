...
parent_path ="/World/h1_2_26dof_with_inspire_rev_1_0/left_hand_camera_base_link"  # the one you want to attach TO
child_path = "/World/realsense_asset"   # the one you want to attach
